-- Run this directly in Supabase Studio → SQL Editor to seed campuses and offices.
-- Safe to run on an existing database — uses ON CONFLICT DO UPDATE.
-- Does NOT touch employees, users, or any other tables.
...
-- ---------------------------------------
-- offices (58 standard offices × every campus)
-- ---------------------------------------
