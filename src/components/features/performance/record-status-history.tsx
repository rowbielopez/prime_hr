...
import type { PerformanceStatusHistoryItem } from "@/features/performance/repository/records.repository";

export function RecordStatusHistory({ rows }: { rows: PerformanceStatusHistoryItem[] }) {
  return (
    <Card>
      <CardHeader>
