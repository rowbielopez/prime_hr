...
export function CommandPalette({
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="glass-panel premium-border max-h-[min(42rem,92vh)] max-w-2xl gap-0 overflow-hidden rounded-lg border p-0 shadow-premium-lg">
                {open ? (
                    <CommandPaletteBody
                        items={items}
            ...
            <div className="premium-border border-b p-3">
                <div className="relative">
                    ...
                    <Input
                        ...
                        className="h-10 rounded-md border-0 bg-surface-inset pl-9 shadow-none focus-visible:ring-2"
                        autoFocus
                    />
                </div>
            </div>
                                ...
                                {section.entries.map((entry) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={cn(
                                                "flex w-full cursor-pointer items-center justify-between gap-3 rounded-md px-3 py-2.5 text-left transition-all duration-150 outline-none",
                                                isActive
                                        ...
                                        >
                                            ...
                                            {isActive ? (
                                                <span className="hidden items-center gap-1 sm:inline-flex">
                                                    <span className="rounded border border-border/70 bg-surface-inset px-2 py-0.5 text-[10px] font-medium text-muted-foreground">
                                                        {entry.group}
                                                    </span>
